...
```
⓪ 컨텍스트 확인(초기/편집 판별) → ① 데이터 수신·out_dir 결정 → ② diagram-router 1회
→ ③ 애매한 뷰 확인 → ④ diagram-drawer 병렬 팬아웃 → ⑤ 결과 취합 → ⑥ 요약 보고
```
